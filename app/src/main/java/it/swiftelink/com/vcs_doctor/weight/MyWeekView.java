...
public class MyWeekView extends View {
    ...
    private String[] weekArray = getResources().getStringArray(it.swiftelink.com.vcs_doctor.R.array.days);
    ...
    public MyWeekView(Context context, AttributeSet attrs, int defStyleAttr) {
